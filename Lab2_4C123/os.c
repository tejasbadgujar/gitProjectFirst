...
int32_t counter = 0;
uint32_t period_1 = 0, period_2 = 0;
typedef void(*callBack)(void);
callBack periodicTask1Pt, periodicTask2Pt;
//void (*periodicTask1Pt )(void);
//void (*periodicTask2Pt)(void);
...
int OS_AddPeriodicEventThreads(void(*thread1)(void), uint32_t period1,
  ...
  periodicTask1Pt = thread1;
  periodicTask2Pt = thread2;
...
void Scheduler(void){ // every time slice
  ...
  //***YOU IMPLEMENT THIS FUNCTION*****
	...
	if ((counter%period_1)==0)
	{
		(*periodicTask1Pt)();
	  //periodicTask_1();	
	}
	if ((counter%period_2)==0)
	{
		periodicTask_2();
		counter = 0;
	}
